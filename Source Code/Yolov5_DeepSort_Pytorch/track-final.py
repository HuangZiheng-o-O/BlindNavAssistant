...
def detect(opt):
    ...
    deepsort = DeepSort(deep_sort_model,
                        device,
                        max_dist=cfg.DEEPSORT.MAX_DIST+2,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_model', nargs='+', type=str, default='best.pt', help='model.pt path(s)')     #默认改yolov5s了，快一点
    parser.add_argument('--deep_sort_model', type=str, default='osnet_ibn_x1_0_MSMT17')
    parser.add_argument('--source', type=str, default='D:\Yolov5_DeepSort_Pytorch\Yolov5_DeepSort_Pytorch\yolov5\data\VID_20220216_132540.mp4', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--show-vid', default=True, action='store_true', help='display tracking video results')  # 增加了 default=True, 直接默认开启
